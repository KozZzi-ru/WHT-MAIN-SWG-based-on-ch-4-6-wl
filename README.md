...
- **P0.29** - Col 1
- **P0.9** - Col 2
- **P0.10** - Col 3 (MK2 black)
- **P1.13** - Col 4 (MK2 black)
- **P1.4** - Col 5
...
### 08.02.2026 - Адаптация col-gpios для МК2 (черная клавиатура)
- Создан новый бранч `BLK-MAIN-SWG-NewZMK`
- Изменены GPIO пины для 4-й и 5-й колонок матрицы клавиш на обеих половинах
- Левая половина: 4-я колонка gpio1 0 → gpio0 10, 5-я колонка gpio0 11 → gpio1 13
- Правая половина: 4-я колонка gpio1 0 → gpio0 10, 5-я колонка gpio0 11 → gpio1 13
- Настройки трекбола остались от МК1 (pmw3610-alt драйвер с swap-xy, invert-x/y, force-awake)
- Обновлен README: указаны пины для МК2, обновлены списки свободных пинов
